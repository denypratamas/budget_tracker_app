...
# Input Section
st.subheader("📥 Monthly Income and Expenses Input")
income_data = []
needs_data = []
wants_data = []
...
with st.form("income_form"):
    ...
    submitted = st.form_submit_button("Calculate Saving Rate")
...
if submitted:
    ...
    # Plot 1: Savings Rate
    st.subheader("📈 Monthly Savings Rate Chart")
